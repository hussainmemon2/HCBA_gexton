...
use App\Http\Controllers\Api\Users\ElectionVoteController;
...
Route::middleware('api.auth')->prefix('elections')->group(function () {
    ...
    Route::controller(ElectionApplicationController::class)->group(function () {
        ...
        Route::post('/{election}/submit', 'submit');
    });
    ...
    Route::controller(ElectionVoteController::class)->group(function () {
        Route::get("{election}/candidates", 'listCandidates');
    });
});
